...
24/7 deep multi-model bug-hunting automation for **Derdack GmbH / Derdack Group** (Oliver Maicher bug-bounty hub).

Scope: All company-owned infrastructure, websites, APIs, SaaS platforms, mobile applications, backend systems, status pages, and domains operated by Derdack GmbH and its products, including SIGNL4 and Enterprise Alert
...
> is never accepted. Active testing is gated behind the in-scope hosts in `inventory/derdack.md` and
...
Program description: German software company providing mobile alerting, incident response, and enterprise notification solutions
